...
template<typename Dtype>
void caffe_nrm2(const int n, const Dtype* a, Dtype* b);
...
void caffe_rng_int_uniform(const int n, const int a, const int b, int* r) ;
template <typename Dtype>
...
template<typename Dtype>
void caffe_gpu_nrm2(const int n, const Dtype* a, Dtype* b);
